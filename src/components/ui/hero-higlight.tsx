...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[40rem] w-full items-center justify-center bg-bg",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r px-1 pb-1 from-primary to-primary/70 text-bg`,
        className,
      )} 
    >
      {children}
